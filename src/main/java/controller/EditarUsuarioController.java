...
public class EditarUsuarioController implements Serializable {
    ...
    public String editarUsuario(){
        String navegacion = "listarUsuarios.xhtml";
    ...
    public String volverListarUsuarios() {
        String rutaRelativa = FacesContext.getCurrentInstance().getExternalContext().getApplicationContextPath() + "/privado/administrador/listarUsuarios.xhtml?faces-redirect=true";
        return rutaRelativa;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 97 * hash + Objects.hashCode(this.listUserCon);
        hash = 97 * hash + Objects.hashCode(this.usuarioEJB);
        hash = 97 * hash + Objects.hashCode(this.personaEJB);
        hash = 97 * hash + Objects.hashCode(this.rolEJB);
